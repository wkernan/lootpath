...
Last updated: 2026-09-06 (M2-1, WKE-518: QEImport shipped - the verdict model, the version pin, and the sign conventions verified twice from QE Live's source; see §6, §7 and §9).
